...
def main():
    ...
    for i in range(0, len(start_states)):    
        ...
        path2, cost2, expanded_astar2 = astar.astar2(start, goal) # Replace the None, None, None with a call to A*
        time_end2 = time.time()

        nodes_expanded_astar2.append(expanded_astar2)
        time_astar2.append(time_end2 - time_start2)
    ...
    plotter.plot_results(time_astar, time_astar2, "Running Time (A*)", "Running Time (A* (2))", "runtimeComp")
    plotter.plot_results(nodes_expanded_astar, nodes_expanded_astar2, "Nodes Expanded (A*)", "Nodes Expanded (A* (2))", "expandComp")
